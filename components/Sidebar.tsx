...
import { CodeIcon, BookOpenIcon, ChartBarIcon, MapIcon, UserCircleIcon, LinkIcon, MailIcon, ChatBubbleIcon } from './icons';
...
const Sidebar: React.FC = () => {
  const { currentPage, setCurrentPage, setIsChatbotOpen } = useContext(AppContext) as AppContextType;
      ...
      <div className="flex flex-col flex-grow p-4">
        ...
        <nav className="flex-1 space-y-2">
          ...
          <button
            ...
            className="flex items-center w-full px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 text-dark-text-secondary hover:bg-dark-hover hover:text-white"
