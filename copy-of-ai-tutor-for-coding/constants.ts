...
# There's a syntax error in the function definition
print(find_max([1, 2, 3, 10, 4]))`,
  JavaScript: `function getGreeting(name) {
    var message = "Hello, " + name;
    return message;
}

// This code works, but can it be improved with modern JS?
console.log(getGreeting("User"));`,
  Java: `public class Greeter {
    public static void main(String[] args) {
        String name = "World";
        System.out.println("Hello, " + name);
        // What if we forget a semicolon?
    }
}`,
  'C++': `#include <iostream>
#include <string>
